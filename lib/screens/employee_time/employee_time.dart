...
class _EmployeeTimeViewState extends State<EmployeeTimeView> {
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  DataTable(
                                                    ...
                                                    rows: [
                                                      for (var j in accountModel
                                                          .employeeTime.values
                                                          .where((element) {
                                                        if (selectedMonth !=
                                                            'الكل'.tr) if (selectedDay ==
                                                                '' ||
                                                            selectedDay ==
                                                                'الكل'.tr)
  ...
  List<DataRow> _buildDataRows(
      AccountManagementViewModel accountController, double size) {
    List<AccountManagementModel> employees =
        accountController.allAccountManagement.values.toList();
            ...
            child: Row(
              ...
              children: [
                ...
                if (employees[index]
                    ...
                    .values
                    .where((element) =>
                        element.dayName == selectedDate.text.split(' ')[0])
                    .isEmpty)
                  AppButton(
                    text: "غائب",
                    onPressed: () {
